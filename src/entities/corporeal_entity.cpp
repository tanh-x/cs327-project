...
bool CorporealEntity::moveBy(int dx, int dy) {
...
// @formatter:off
CorporealEntity* CorporealEntity::spawnNpc(EntityEnum type, int mapX, int mapY) {
    switch (type) {
...
Event* CorporealEntity::constructEventOnTurn() {
